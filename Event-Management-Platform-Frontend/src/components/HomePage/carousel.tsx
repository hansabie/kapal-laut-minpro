...
const Carousel: React.FC<CarouselProps> = ({ images }) => {
  ...
  return (
    <div className="relative w-[90%] mt-0 justify-center" data-carousel="slide">
      <div className="space-y-5 sm:space-y-7 mb-3 pl-2 text-primary text-left sm:text-left lg:text-left">
        <h1 className="text-4xl sm:text-2xl lg:text-3xl font-bold">
          Highlights of <span className="text-secondary">this Week</span>
        </h1>
      </div>
